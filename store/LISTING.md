...
| File | Use |
|---|---|
| `parcel-intelligence-1.1.0.zip` | Upload as the package (Store dashboard → Package → Upload new package). Built from `dist/`, manifest at the zip root. |
...
- [ ] `manifest.json` version is `1.1.0` (bump for every future upload; see CHANGELOG.md).
